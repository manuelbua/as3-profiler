...
// This ActionScript profiling system has been developed following the ideas
// of an article of Steve Rabin in the Game Programming Gems 1 book.
...
package profiler
{
	...
	public class Profiler extends Sprite
	{
		 ...
		 * Construction
		 */
		public function Profiler( anUpdateFrequencyFrames: int = 16, rootNodeIsGroupNode: Boolean = true )
		{
			frameCount = 0;
			...
			rootNode.setIsGroupNode( rootNodeIsGroupNode );
			currNode = rootNode;
			nodes.push( currNode );
...
*/
		...
		public function begin( aName: String, isGroupNode: Boolean = false ): void
		{
			if( currNode.getName() != aName )
			{
				...
				else
				{
					...
					pnode.setIsGroupNode( isGroupNode );
					nodes.push( pnode );
